...
class FeatureFlags {
  ...
  bool get isAndroidEmbeddingV2Enabled =>
      isEnabled(flutterAndroidEmbeddingV2Feature);
  ...
  bool isEnabled(Feature feature) {
    ...
    if (feature.configSetting != null) {
      final bool configOverride =
          globals.config.getValue(feature.configSetting) as bool;
      if (configOverride != null) {
        isEnabled = configOverride;
      }
    }
    if (feature.environmentOverride != null) {
      if (globals.platform.environment[feature.environmentOverride]
              ?.toLowerCase() ==
          'true') {
        isEnabled = true;
      }
