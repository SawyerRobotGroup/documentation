...
- More information [here](games/colored_trails/Automatic Mode.md)
...
- More information [here](games/colored_trails/Manual Mode.md)

### GUI and Server

To read more on the inplementation of the GUI and Server go [here](games/colored_trails/Framework.md)
...
For more reading on Colored Trails, go [here](games/colored_trails/Further Readings.md)
