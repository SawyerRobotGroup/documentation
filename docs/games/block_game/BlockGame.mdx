...
- More information [here](games/block_game/HumanvsHuman)
...
- More information [here](games/block_game/HumanvsAI)
...
- More information [here](games/block_game/AIvsAI)

### GUI and Server

To read more on the inplementation of the GUI and Server go [here](games/block_game/Framework)
