...
The system to play with the physical robot is described in [system requirements](/system/System Requirements.md)
...
To speak to the AI or robot, [the speech app](system/speech/Speech App.md) is used to capture the speech. It is then processed and sent to the Algorithm.
