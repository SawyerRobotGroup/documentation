...
This is a project for controling all of the subsystems needed to play [the block game](games/Block Game.md) in user studies as well as for displaying the current game state.
