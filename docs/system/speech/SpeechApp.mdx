...
The *Speech App* is a mobile application developed in flutter that is used to capture speech from users and sends it to [mic.py](./Mic)for processing.
...
This page is used for capturing the speech of the user. Users press and hold on the green button and release to send the audio. To cancel they swipe down. The audio is sent over the **chat** topic to [mic.py](./Mic)
