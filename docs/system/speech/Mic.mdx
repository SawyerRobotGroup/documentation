...
*mic.py* is a python3 server that processes speech recieved from [the speech app](/system/speech/SpeechApp), matches it to a valid speech act, and then send the verified speech to `game/game_flow/Robot/command_server.py` in game_flow.
